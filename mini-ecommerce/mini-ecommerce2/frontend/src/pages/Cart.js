                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-lg-2 mt-4 mt-lg-0">
                                            <p id="card_item_price"className='bg-primary'>${item.product.price}</p>
                                            <p id="card_item_price"className='bg-info'>{item.product.discount}%</p>
                                            <p id="card_item_price"className='bg-danger'>{item.product.availabiliy}</p>
                                        </div>
